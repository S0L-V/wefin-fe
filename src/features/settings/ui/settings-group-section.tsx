      ...
      <div className="space-y-6">
        <div className="rounded-2xl border border-wefin-line bg-wefin-bg p-5">
          <div className="flex items-start justify-between gap-4 max-md:flex-col">
            <div>
              <p className="text-sm font-semibold text-wefin-subtle">현재 소속 그룹</p>
              <p className="mt-1 text-lg font-bold text-wefin-text">{groupName}</p>
        ...
        {!isHomeGroup && isLoggedIn ? (
          <div
            className={[
              ...
              isCodeConsumed ? 'border-orange-200' : 'border-wefin-line'
            ].join(' ')}
          >
