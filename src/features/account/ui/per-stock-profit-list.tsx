...
export default function PerStockProfitList({
  ...
  return (
    <ul className="divide-y divide-wefin-line">
      {rows.map((row) => {
        const totalColor = row.total >= 0 ? 'text-wefin-red' : 'text-wefin-blue'
        return (
          <li key={row.code}>
            <Link
              ...
              <div className="min-w-0 flex-1">
                ...
                <div className="flex gap-2 text-xs tabular-nums">
                  <span className="text-wefin-subtle">
                    미실현{' '}
                    <span className={row.unrealized >= 0 ? 'text-wefin-red' : 'text-wefin-blue'}>
                      {row.unrealized >= 0 ? '+' : ''}
                  ...
                  <span className="text-wefin-subtle">
                    실현{' '}
                    <span className={row.realized >= 0 ? 'text-wefin-red' : 'text-wefin-blue'}>
                      {row.realized >= 0 ? '+' : ''}
