...
function PlayPage() {
  ...
  return (
    <>
      {/* 데스크탑 레이아웃 */}
      <div className="fixed inset-0 top-[56px] z-20 hidden flex-col overflow-hidden bg-wefin-bg lg:flex">
      ...
      {/* 모바일 레이아웃 */}
      <div className="fixed inset-0 top-[56px] z-20 flex flex-col overflow-hidden bg-wefin-bg lg:hidden">
